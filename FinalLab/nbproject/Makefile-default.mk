...
SOURCEFILES_QUOTED_IF_SPACED=Fan_Support.c I2C_Soft.c I2C_Support.c Interrupt.c Main.c Main_Screen.c Setup_Alarm_Time.c Setup_Heater_Temp.c Setup_Time.c utils.c ST7735_TFT.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Heater_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/ST7735_TFT.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Fan_Support.p1.d ${OBJECTDIR}/I2C_Soft.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/Main.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/Setup_Alarm_Time.p1.d ${OBJECTDIR}/Setup_Heater_Temp.p1.d ${OBJECTDIR}/Setup_Time.p1.d ${OBJECTDIR}/utils.p1.d ${OBJECTDIR}/ST7735_TFT.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Heater_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/ST7735_TFT.p1

# Source Files
SOURCEFILES=Fan_Support.c I2C_Soft.c I2C_Support.c Interrupt.c Main.c Main_Screen.c Setup_Alarm_Time.c Setup_Heater_Temp.c Setup_Time.c utils.c ST7735_TFT.c
...
${OBJECTDIR}/I2C_Soft.p1: I2C_Soft.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/I2C_Soft.p1 I2C_Soft.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/LabFinal.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LabFinal.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-fd30-ffff --ram=default,-ef4-eff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LabFinal.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF) 
