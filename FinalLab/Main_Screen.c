...
void Update_Screen(void)
{
    ...
    Heater_Set_Temp_Txt[0] = heater_set_temp/100 + '0';     // normal calculation
    ...
    DC_Txt[0] = duty_cycle/100 + '0';                       // normal calculation
    DC_Txt[1] = ((duty_cycle/10) % 10) + '0';
    DC_Txt[2] = duty_cycle%10 + '0';    
    
    Volt_Txt[0] = ((int)volt) + '0';                        // calculation with decimal
    Volt_Txt[2] = ((int)(volt*10)) % 10 + '0';
    Volt_Txt[3] = ((int)(volt*100)) % 10 + '0';
    
    RPM_Txt[0] = rpm/1000 + '0';                            // further calculator
