...
{    
    ...
    switch(Nec_state)
    {
        ...
        case 1 :
        {  
            if((Time_Elapsed >= 8500) && (Time_Elapsed <= 9500)) Nec_state = 2;            // if true nec state = 2
            else force_nec_state0();                // force nec state 0
        ...
        case 2 :
        {
            if((Time_Elapsed >= 4000) && (Time_Elapsed <= 5000)) Nec_state = 3;            // if true nec state = 2
            else force_nec_state0();                // force nec state 0
            INTCON2bits.INTEDG0 = 1;                // Change Edge interrupt of INT0 to Low to High     
            return;
        }
        ...
        case 3 :
        {
            if((Time_Elapsed >= 400) && (Time_Elapsed <= 700)) Nec_state = 4;            // if true nec state = 2
            else force_nec_state0();                // force nec state 0
            INTCON2bits.INTEDG0 = 0;                // Change Edge interrupt of INT0 to High to Low  
            return;
        }
        ...
        case 4 :
        {
            ...
            {
                Nec_code = Nec_code << 1;           // Shift left by 1
